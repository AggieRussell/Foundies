...
public class Chats extends Fragment {
    ...
    public void sendTextMessage(View v) {
        ...
        controller.createMessage(Utility.uniqueID(),controller.getUser().getEmail(), "b@c.com",
                message, 2, Utility.getDate());


        if (!message.equalsIgnoreCase("")) {
            final ChatMessage chatMessage = new ChatMessage(Utility.uniqueID(),controller.getUser().getEmail(), "b@c.com",
                    message, 2, Utility.getDate());
