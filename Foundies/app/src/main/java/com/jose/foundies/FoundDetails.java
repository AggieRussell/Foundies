...
public class FoundDetails extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout = (LinearLayout) findViewById(R.id.foundDetailsLinearLayout);
        ...
        final Button next = (Button) findViewById(R.id.found_button);
